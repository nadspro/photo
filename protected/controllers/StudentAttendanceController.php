...
if($model->present="0000-00-00"){     ///and condition was not working hence nested if was used.........
if($model->absent_inform="0000-00-00"){
	 ...
	 * @param StudentAttendance $model the model to be validated
	 */
