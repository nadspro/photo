            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="#">Confirm Admission for Token No #<?php echo $model->id; ?> </a></li>
                  </ul>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                     ...
                     <div class="tab-content">
                           ...
                           <div class="portlet box blue">
                              <div class="portlet-title">
                               <h4><i ></i>Confirm Admission for Token No #<?php echo $model->id; ?> </h4>
                                 <div class="tools">
...
<?php echo $this->renderPartial('_form1', array('model'=>$model)); ?>
								  ...
								  <a href="index.php?r=preadmission/view&id=<?php echo $model->id; ?>"<button type="submit" class="btn blue"><i class="icon-pencil"></i>Update</button></a>
