                              ...
                              <div class="tab-content">
                                 <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <?php echo $form->textField($model,'S_fname',array('size'=>30,'maxlength'=>30))." ".$form->textField($model,'S_mname',array('size'=>30,'maxlength'=>30))." ".$form->textField($model,'S_lname',array('size'=>30,'maxlength'=>30)); ?>
