...
<body class="fixed-top">
   ...
   <div class="page-container row-fluid">
			...
			<ul>
				...
				<li class="has-sub ">
					...
					<ul class="sub">
						...
						<li ><a href="index.php?r=preadmission/index">List Students</a></li>
						<li ><a href="ui_tabs_accordions.html">List Parents</a></li>
						<li ><a href="index.php?r=preadmission/admin">Applications Recieved</a></li>
						</ul>
				</li>
				<li class="has-sub ">
					<a href="javascript:;">
                  ...
                  <div class="tabbable tabbable-custom boxless">
                     ...
                     <div class="tab-content">
                              ...
                              <div class="portlet-title">
                                 <h4><i ></i>View Admission Form for Token No #<?php echo $model->id; ?></h4>
                                 <div class="tools">
    ...
    echo '<img class="imgbrder" src="'.$this->createUrl('DisplaySavedImage&id='.$model->primaryKey).'" alt="'.$model->photo_file_name.'" width="101" height="107" />';
		...
		echo '<img class="imgbrder" src="images/pdf-but.png" alt='.$model->S_fname.' width="101" height="107" />'; 
	 }
	 ?>
	...
	'attributes'=>array(
		...
		'photo_file_size',
                                    ...
                                    <div class="form-actions">
									  ...
									  <a href="index.php?r=preadmission/update&id=<?php echo $model->id; ?>"<button type="submit" class="btn blue"><i class="icon-pencil"></i>Update</button></a>
						...
						<a href="index.php?r=preadmission/delete" onclick="return confirmAction()"><button type="submit" class="btn blue">Delete Not Working</a>
 ...
 return confirmed;
									    ...
									    <?php   $this->menu=array(
	array('label'=>'Delete Preadmission', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
);
?>
...
<?php echo CHtml::link('<img src="images/pdf-but.png">', array('Preadmission/pdf','id'=>$_REQUEST['id']),array('target'=>'_blank')); ?>
