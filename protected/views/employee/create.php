         ...
         <!-- BEGIN SIDEBAR MENU -->        	
			<ul>
				...
				<li class="has-sub ">
					...
					<ul class="sub">
						<li ><a href="index.php?r=employee/create">Add New Employee</a></li>
...
<?php echo $this->renderPartial('_form', array('model'=>$model)); ?>
										 ...
										 <a href="index.php?r=employee/admin"<button type="submit" class="btn yellow"><i class="icon-pencil"></i>Manage Application</button></a>
