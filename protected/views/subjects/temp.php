	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','DynamicSubjects','DynamicSubSection','create','update'),
				'users'=>array('*'),
			),
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<tr><div class="row">
		...
		<td><?php echo $form->dropDownList($model,'sub_id',array(
	    																'ajax' => array(
																		'type'=>'POST',
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<tr><div class="row">
		...
		<td><?php
				$classArray = CHtml::listData(Classes::model()->findAll(),'id','class_name');
                 echo CHtml::dropDownList('class_id','', $classArray,
                array(
                    'prompt'=>'Select Class',
                    'ajax' => array(
                        'type'=>'POST',
                        'url'=>CController::createUrl('SubTopic/updateSubjects'), 
                        'dataType'=>'json',
                        'data'=>array('class_id'=>'js:this.value'),  
                        'success'=>'function(data) {
                            $("#sub_id").html(data.dropDownSubjects);
                            $("#sub_section_id").html(data.dropDownSubSection);
                        }',
            ))); 
		?></td>
        <td><?php echo $form->error($model,'class_id'); ?></td>
	...
	<tr><div class="row">
		<td><?php echo $form->labelEx($model,'sub_id'); ?></td>
		<td><?php 
				echo CHtml::dropDownList('sub_id','', array(),
                array(
                    'prompt'=>'Select Subject',
                    'ajax' => array(
                        'type'=>'POST', 
                        'url'=>CController::createUrl('SubTopic/updateSubSection'), 
                        'update'=>'#sub_section_id', 
	...
	<div class="row">
		<?php echo $form->labelEx($model,'sub_section_id'); ?>
		<?php //echo $form->dropDownList($model,'sub_section_id',array());  
		      echo CHtml::dropDownList('sub_section_id','', array(), array('prompt'=>'Select Section'));?>
		<?php echo $form->error($model,'sub_section_id'); ?>
	</div>
