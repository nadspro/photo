...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>MyCollege | Blog Grid</title>
                ...
                <div id="menu">
                    <section>
                        ...
                        <ul class="clearfix">
                            ...
                            <li class="selected"><a href="blog-grid.html">Blog</a>
                                <ul class="sub-menu">
        ...
        <div id="contentBk" class="clearfix">
            <div id="content">
                <div class="topImg clearfix">
                    ...
                    <p>Our <strong>Blog</strong></p>
                </div>
                <div class="wrapper">
                    <div class="blog column c-67 clearfix">
                        <div class="box">
                            <a href="blog-post.html"><h4>What about a fun post?</h4></a>
                            <div class="boxInfo examInfo">
                                ...
                                <div>
                                    ...
                                    elit, sed do eiusmod tempor incididunt ut labore et dolore na aliqua.</p>
                                    <p>Ut enim ad minim veniam, quinostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo. </p>
                                    <a href="blog-post.html" class="submit"> Read more </a>
                                </div>
                            </div>
                        </div>

                        <div class="box">
                            <a href="blog-post.html"><h4>Exam running in classroom</h4></a>
                            <div class="boxInfo examInfo">
                                <ul>
                                    <li class="proExm"><a href="#"> John Deo</a></li>
                                    <li class="dateExm">Dec 16.2012</li>
                                ...
                                <div>
                                    <img class="fwidth" src="assets/img/blog/img2.jpg" alt="">
                        ...
                        <div class="box">
                            <a href="blog-post.html"><h4>A Classroom</h4></a>
                            <div class="boxInfo examInfo">
                                <ul>
                                    <li class="proExm"><a href="#"> John Deo</a></li>
                                    <li class="dateExm">Dec 16.2012</li>
                                ...
                                <div>
                                    <img class="fwidth" src="assets/img/blog/img3.jpg" alt="">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labor dolore magna aliqua. Ut enim ad minim veniam, quinostrud exercitation ullamco laboris nisi ut aliqu ip ex ea commodo.  </p>
                                    <a href="blog-post.html" class="submit"> Read more </a>
                                </div>
                            </div>
                    ...
                    <div id="sidebar" class="column c-33 clearfix">
                        ...
                        <div class="clearfix">
                         ...
                         <div class="blogPost clearfix">
                            <div class="box">
                                ...
                                <ul class="tabs">
                                    <li class="selected"><a href="#">Popular post</a></li>
                                    <li><a href="#">Recent post</a></li>
                                </ul>
                                <ul class="content clearfix">
                                    <li class="selected">
                                        <div class="boxInfo">
                                            <img src="assets/img/blog/avatar2.jpg" alt="">
                                            <p><a href="blog-post.html">Donec sed odio dui Maecena sed diam rius</a></p>
                                            <span>01 May, 2011</span>
                                        </div>
                                        <div class="boxInfo">
                                            <img src="assets/img/blog/avatar2.jpg" alt="">
                                            <p><a href="blog-post.html">Lorem ipsum dolor sit amet, consectetur</a></p>
                                            <span>15 July, 2011</span>
                                        </div>
                                        <div class="boxInfo">
                                            <img src="assets/img/blog/avatar2.jpg" alt="">
                                            <p><a href="blog-post.html">Adipisicing elit, sed do eiusmod tempor incididunt</a></p>
                                    ...
                                    <li>
                                        <div class="boxInfo">
                                            <img src="assets/img/blog/avatar2.jpg" alt="">
                                            <p><a href="blog-post.html">Sed ut perspiciatis unde omnis iste</a></p>
                                            <span>04 July 2013</span>
                                        </div>
                                        <div class="boxInfo">
                                            <img src="assets/img/blog/avatar2.jpg" alt="">
                                            <p><a href="blog-post.html">1914 translation by H. Rackham</a></p>
                                            <span>22 May, 2013</span>
                                        </div>
                                        <div class="boxInfo">
                                            <img src="assets/img/blog/avatar2.jpg" alt="">
                                            <p><a href="blog-post.html">At vero eos et accusamus et iusto</a></p>
                        ...
                        <div class="clearfix">
                            <div class="box tour course">
                                <h4>Campus <strong>tour</strong></h4>
                        ...
                        <div class="flickr clearfix">
                            <div class="box">
                                <h4>Flickr Photos</h4>
                                <div class="boxInfo flickrList" data-no="6" data-id="52617155@N08"></div>
                            </div>
                        </div>         
