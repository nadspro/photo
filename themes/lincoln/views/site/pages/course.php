            ...
            <div id="content">
                ...
                <div class="wrapper">
                    ...
                    <div class="course column c-67 clearfix">
                        ...
                        <h3 class="title">List <strong>View</strong></h3>
                        ...
                        <div class="box">
                            ...
                            <div class="boxInfo">
                                <p>Something about course iusmod tempor doloreidoloreiusmod tempor usmod tempordolor eiusmod tempor...</p>
                            </div>
                            <div class="courseInfo">
                                <p class="courseTime">Time: 13.00-16.00</p>
                                <ul>
                                    <li class="courseRoom">Room No: T250</li>
                                    <li class="courseInstructor">Instructor: Nibh Cras</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <h3 class="title">Tabel <strong>View</strong></h3>
                    ...
                    <div id="sidebar" class="column c-33 clearfix">
                        ...
                        <div class="clearfix">
                            <div class="box">
                                <a href="#"><h4>Professor: <strong>Jasson Wilss</strong></h4></a>
                                <div class="boxInfo">
                                    <img class="fwidth" src="assets/img/professors/p1.jpg" alt="">
