    ...
    <body>
        ...
        <header>
            ...
            <div>
                ...
                <div id="menu">
                    <section>
                        ...
                        <ul class="clearfix">
                            ...
                            <li><a href="index.php?r=site/page&view=course">Course</a></li>
                            <li><a href="professors.html">Professors</a></li>
                            <li><a href="blog-grid.html">Blog</a>
                                <ul class="sub-menu">
                                    <li><a href="index.php?r=site/bloggrid.php">Blog Grid</a></li>
                ...
                <div id="tagline">
                    <section>
                        <a href="#">“ Admission Open for 2012 click here to <strong>Get Form</strong> ”</a>
                    </section>
                </div>
                <div id="info">
                    <section>
        ...
        <div id="contentBk">
            <div id="content" class="clearfix">
                ...
                <div id="homeSlider" class="clearfix flexslider">
                    ...
                    <ul class="slides">
                        <li data-thumb="assets/img/slider/1st_thumb.jpg"><img src="img/slider/1st.jpg" alt="A Classroom"></li>
                        <li data-thumb="assets/img/slider/2nd_thumb.jpg"><img src="img/slider/2nd.jpg" alt="Just a different perspective over this new issue"></li>
                        <li data-thumb="assets/img/slider/3rd_thumb.jpg"><img src="img/slider/3rd.jpg" alt="A Classroom"></li>
                        <li data-thumb="assets/img/slider/4th_thumb.jpg"><img src="img/slider/4th.jpg" alt="Just a different perspective over this new issue"></li>
                    </ul>
                ...
                <div class="wrapper">
                    ...
                    <div class="welcome column c-67 clearfix">
                        <h3>Welcome to My College</h3>
                        <div class="cContent clearfix">
                            <img src="assets/img/other/welcome.jpg" alt="">
                            <div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do 
                                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut 
                                enim ad minim veniam, quis nostrud exercitation ullamco laboris 
                                nisi ut aliquip ex ea commodo consequat.<a href="#"> Read more</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="news column c-33 clearfix">
                        <h3>College Daily News</h3>
                        <div class="arrows"></div>
                        <div class="cContent clearfix rotator">
                            <ul class="slides">
                                <li>
                                    <div class="post">
                                        <img src="assets/img/other/news.png" alt="">
                                        <div class="info">
                    ...
                    <div class="links column c-33 clearfix">
                        ...
                        <ul class="cContent clearfix">
                            ...
                            <li><a href="#">Introducing Genetic Engineeringon</a></li>
                            <li><a href="#">Celebrating Funder's Day</a></li>
                            <li><a href="#">Admissions are open for 2012</a></li>
                            <li><a href="#">The university Building</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="event column c-67 clearfix">
                        ...
                        <div class="cContent clearfix rotator">
                            <ul class="slides">
                                <li><a href="assets/img/events/e1_large.jpg" rel="lightbox[events]" class="grayColor"><img data-color="img/events/e1.jpg" src="img/events/e1_gray.jpg" alt="" class="imgBorder"></a></li>
                                <li><a href="assets/img/events/e2_large.jpg" rel="lightbox[events]" class="grayColor"><img data-color="img/events/e2.jpg" src="img/events/e2_gray.jpg" class="imgBorder" alt=""></a></li>
                                <li><a href="assets/img/events/e3_large.jpg" rel="lightbox[events]" class="grayColor"><img data-color="img/events/e3.jpg" src="img/events/e3_gray.jpg" alt="" class="imgBorder"></a></li>
                                <li><a href="assets/img/events/e4_large.jpg" rel="lightbox[events]" class="grayColor"><img data-color="img/events/e4.jpg" src="img/events/e4_gray.jpg" class="imgBorder" alt=""></a></li>
                                <li><a href="assets/img/events/e5_large.jpg" rel="lightbox[events]" class="grayColor"><img data-color="img/events/e5.jpg" src="img/events/e5_gray.jpg" class="imgBorder" alt=""></a></li>
                                <li><a href="assets/img/events/e6_large.jpg" rel="lightbox[events]" class="grayColor"><img data-color="img/events/e6.jpg" src="img/events/e6_gray.jpg" class="imgBorder" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="featured column c-33 clearfix">
                        ...
                        <div class="cContent">
                            <img class="imgBorder" src="assets/img/professors/1st.jpg" alt="">
                            <div>
                                <h5>Jason Wills</h5>
                                <p>Lorem ipsum dolorpsu eiusmod tempor... </p>
                                <a href="#">Read more</a>
                            </div>
                        </div>
                    </div>
        ...
        <footer>
            ...
            <div class="stripe clearfix">
                <div class="twitter">
                    <img src="assets/img/twitter.png" alt=""><div class="twitterList" data-user="rubenbristian"></div>
                </div>
            </div>
            ...
            <div id="footerContent" >
                <section>
                    ...
                    <div id="bottomFooter">
                        <p>© 2012 My College. All Rights Reserved</p>
                        <div>
                            <ul id="social" >
