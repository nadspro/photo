...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>MyCollege | About Us</title>
                ...
                <div class="wrapper">
                    ...
                    <div class="column c-33 clearfix">
                        <div class="box">
                            ...
                            <div class="boxInfo">
                                <img class="fwidth" src="assets/img/professors/p2.jpg" alt="">
                    ...
                    <div class="column c-33 clearfix">
                        <div class="box">
                            <h4>Professor:<strong>  Jasson Wilss</strong></h4>
                            <div class="boxInfo">
                                <img class="fwidth" src="assets/img/professors/p3.jpg" alt="">
